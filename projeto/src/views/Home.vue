...
<ul class="c-menu__ul">
  ...
  <li id="reguladores" v-on:click="getReguladores()" class="c-menu__li">
  ...
  <li  id="socioAmbiental" v-on:click="getSocioAmbiental()" class="c-menu__li">
  ...
  <li id="juridico" v-on:click="getJuridico()" class="c-menu__li">
  <svg class="c-icone" version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 425.2 425.2" style="enable-background:new 0 0 425.2 425.2;" xml:space="preserve"><g id="hammer-2"><path class="st0" d="M2.7,381.6l156.5-156.4c3.7-3.6,9.6-3.6,13.2,0l1.8,1.8l28.4-28.6l-25.9-25.9c-3.6-3.7-3.6-9.6,0-13.2 l80.5-80.5c3.7-3.6,9.6-3.6,13.2,0l75.9,75.9c3.6,3.7,3.6,9.6,0,13.2l-80.5,80.5c-3.7,3.6-9.6,3.6-13.2,0l-25.9-25.9l-28.4,28.4 l1.8,1.8c3.6,3.7,3.6,9.6,0,13.3L43.5,422.5c-3.7,3.6-9.6,3.6-13.2,0L2.9,395C-0.9,391.3-0.9,385.3,2.7,381.6z M152.1,166.4 c-3.7,3.6-9.6,3.6-13.2,0l-38.2-38.2c-3.6-3.7-3.6-9.6,0-13.2l112-112.2c3.7-3.6,9.6-3.6,13.2,0l38.2,38.2c3.6,3.7,3.6,9.6,0,13.2 L152.1,166.4z M310.2,324.5c-3.7,3.6-9.6,3.6-13.2,0l-37.8-37.8c-3.6-3.7-3.6-9.6,0-13.2l112.1-112.3c3.7-3.6,9.6-3.6,13.3,0 l37.8,37.8c3.6,3.7,3.6,9.6,0,13.2L310.2,324.5z"/></g></svg>
  Jurídico</li>
    
  <li id="listasRestritivas" v-on:click="getlistrasRestritivas()" class="c-menu__li">
  <svg class="c-icone" version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 510.2 510.2" style="enable-background:new 0 0 510.2 510.2;" xml:space="preserve"><path class="st0" d="M255.1,506.1c-67,0-130.1-26.1-177.5-73.5C30.2,385.2,4.1,322.1,4.1,255.1S30.2,125,77.6,77.6C125,30.2,188.1,4.1,255.1,4.1c67,0,130.1,26.1,177.5,73.5C479.9,125,506,188,506,255.1s-26.1,130.1-73.4,177.5C385.2,480,322.1,506.1,255.1,506.1z M99.4,139.7c-24.7,33.3-38.2,73.9-38.2,115.4c0,106.9,87,193.9,193.9,193.9c41.5,0,82-13.5,115.4-38.2L99.4,139.7z M410.8,370.5c24.7-33.3,38.2-73.9,38.2-115.4c0-106.9-87-193.9-193.9-193.9c-41.5,0-82,13.5-115.4,38.2L410.8,370.5z"/><path class="st0" d="M425.5,84.7c-45.5-45.5-106-70.6-170.4-70.6S130.2,39.2,84.7,84.7s-70.6,106-70.6,170.4S39.2,380,84.7,425.5s106,70.6,170.4,70.6S380,471,425.5,425.5s70.5-106,70.5-170.4S471,130.2,425.5,84.7z M459,255.1c0,49.5-17.8,95-47.3,130.4l-287-287c35.4-29.5,80.8-47.3,130.4-47.3C367.5,51.2,459,142.7,459,255.1z M51.2,255.1c0-49.5,17.8-95,47.3-130.4l287,287c-35.4,29.5-80.8,47.3-130.4,47.3C142.7,459,51.2,367.5,51.2,255.1z"/></svg>
  Listras Restritivas</li>

  <li id="midiaInternet" v-on:click="getMidiaInternet()" class="c-menu__li">
  ...
  <li id="bensImoveis" v-on:click="getBensEImoveis()" class="c-menu__li">
  ...
  getAllList(){
    ...
    api
      ...
      getProfissionais(){
        ...
        /*   const li = document.querySelector('#profissional');
           const div = document.querySelector('#imagem');
           this.imagem = li.innerHTML;
           div.innerHTML = this.imagem;
